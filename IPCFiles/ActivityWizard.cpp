...
void ActivityWizard::setVisible(bool bVisible)
{
...
void ActivityWizard::setWidgetVisible(std::string name,bool bVisible)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
void ActivityWizard::setDisabled(bool bDisabled)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
void ActivityWizard::setWidgetDisable(std::string name,bool bDisabled)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
