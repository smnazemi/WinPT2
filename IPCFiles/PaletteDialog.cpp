...
void PaletteDialog::setVisible(bool bVisible)
{
...
void PaletteDialog::setWidgetVisible(std::string widgetName,bool bVisible)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
void PaletteDialog::setDisabled(bool bDisabled)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
void PaletteDialog::setWidgetDisable(std::string widgetName,bool bVisible)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
