...
//************************************************************************
/*! /file
	File Name:	 PortKeepAliveProcess.cpp 
	Author:		 Ajan U. Nair 
...
void PortKeepAliveProcess::setKeepAliveOn(bool bOn)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
	std::string callName="setKeepAliveOn";
...
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
	std::string callName="isKeepAliveOn";
	newBuf->write(callName);
	newBuf->writeTypeValue(eVoid);
	CallResult callResult=m_ipcFramework->makeIPCCall(newBuf);
	if(!callResult.callStatus)
...
void PortKeepAliveProcess::setKeepAliveInterval(int interval)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
	std::string callName="setKeepAliveInterval";
	newBuf->write(callName);
	newBuf->write(eInt);
...
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
	std::string callName="getKeepAliveInterval";
	newBuf->write(callName);
	newBuf->writeTypeValue(eVoid);
	CallResult callResult=m_ipcFramework->makeIPCCall(newBuf);
	if(!callResult.callStatus)
