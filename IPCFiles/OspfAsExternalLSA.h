...
//************************************************************************
/*! /file
	File Name:	 OspfAsExternalLSA.h 
	Author:		 Ajan U. Nair 
	Date:		 Thu August 21 2008  	Time: 13:14:47 pm
	Revision:	 1.1
	Description: IPCFiles are generated using IpcFwGenerator program.
*/
#ifndef IPC_FW_OSPFASEXTERNALLSA_H
#define IPC_FW_OSPFASEXTERNALLSA_H
...
public:
	...
	OspfAsExternalLSA(CPtmpBuffer  *buf)
	{	
		m_className="OspfAsExternalLSA";
...
#endif
//-----data class file : OspfAsExternalLSA.h --end----
