...
//************************************************************************
/*! /file
	File Name:	 CommonToolbar.h 
	Author:		 Ajan U. Nair 
	Date:		 Thu August 21 2008  	Time: 13:14:50 pm
	Revision:	 1.1
	Description: IPCFiles are generated using IpcFwGenerator program.
*/
#ifndef IPC_FW_COMMONTOOLBAR_H
#define IPC_FW_COMMONTOOLBAR_H
...
class CommonToolbar : public IpcBase
{
public :
	CommonToolbar()
	{	
	}	
	CommonToolbar(IPCFrameWork* ipcFw,CPtmpBuffer ptmpBuf)
	{
		m_ipcFramework=ipcFw;
		m_ptmpBuffer=ptmpBuf;
		m_className="CommonToolbar";
	}
	~CommonToolbar()
	{
	}
