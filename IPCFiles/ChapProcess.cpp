...
void ChapProcess::setPassword(std::string password)
{
...
void ChapProcess::setUserName(std::string username)
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
std::string ChapProcess::getUserName()
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
...
std::string ChapProcess::getPassword()
{
	CPtmpBuffer *newBuf= new CPtmpBuffer(m_ptmpBuffer);
